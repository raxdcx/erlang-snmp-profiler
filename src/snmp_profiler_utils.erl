...
usage() ->
	...
	[
	 ...
	 "  -d, --dc=DC      specify a DC to test performance in; must be a DC that",
	 "                   has a datafile included; see DATAFILES; either this or",
	 "                   --test-one must be provided",
	 "  -o, --test-one=SWITCHNAME",
	 "                   test performance of a single switch; either this or the",
	 "                   --dc option must be provided",
